	...
	public function Info($name){
        ...
        $infos = [
            ["route"=>"siteperso", "titre"=>"Siteperso", "titreinfo"=>"", "tailleimg"=>"huge", "img"=>"siteperso.png",
                ...
                "competences"=>"Organiser son développement professionnel (gérer son identité professionnelle)",
                "date"=>"Octobre 2020"
            ],
            ...
            ["route"=>"refonte-site-artiste", "titre"=>"Refonte-Site-Artiste", "titreinfo"=>"", "tailleimg"=>"huge", "img"=>"Refonte-Site-Artiste.png",
                ...
                "competences3"=>"Travailler en mode projet (analyser les objectifs et les modalités de l'organisation d'un projet)",
                "competences4"=>"Mettre à disposition des utilisateurs un service informatique (accompagner les utilisateurs dans la mise en place d'un service)",
                "date"=>"décembre 2020"
            ],
            ...
            ["route"=>"keepass", "titre"=>"KeePass", "titreinfo"=>"", "tailleimg"=>"medium", "img"=>"keepass_logo.png", "video"=>"https://www.youtube.com/embed/pJ5LMMZXM0s",
                ...
                "competences"=>"Mettre à disposition des utilisateurs un service informatique (accompagner les utilisateurs dans la mise en place d'un service)",
                "date"=>"Janvier 2021"
            ],
            ...
            ["route"=>"crm", "titre"=>"CRM", "titreinfo"=>"", "tailleimg"=>"huge", "img"=>"agilecrm.png",
                ...
                "competences3"=>"Travailler en mode projet (analyser les objectifs et les modalités de l'organisation d'un projet)",
                "competences4"=>"Mettre à disposition des utilisateurs un service informatique (déployer un service, accompagner les utilisateurs dans la mise en place d'un service)",
            ...
            ["route"=>"webpoo", "titre"=>"WebPOO", "titreinfo"=>"", "tailleimg"=>"huge", "img"=>"WebPOO.png", "video"=>"https://www.youtube.com/embed/LMfGrRpgTtk",
                ...
                "competences3"=>"Mettre à disposition des utilisateurs un service informatique (déployer un service, accompagner les utilisateurs dans la mise en place d'un service)",
                "date"=>"Avril - Mai 2021"
            ],
            ...
            ["route"=>"proxmox-admin", "titre"=>"Proxmox-admin", "titreinfo"=>"", "tailleimg"=>"huge", "img"=>"proxmox-admin.jpg",
                ...
                "competences3"=>"Mettre à disposition des utilisateurs un service informatique (déployer un service)",
            ...
            ["route"=>"e-music", "titre"=>"E-music", "titreinfo"=>"", "tailleimg"=>"huge", "img"=>"e-music.png",
                ...
                "competences"=>"Gérer le patrimoine informatique(mettre en place et vérifier les niveaux d'habilitation associés à un service)",
                "competences2"=>"Travailler en mode projet (planifier les activités)",
                "competences3"=>"Mettre à disposition des utilisateurs un service informatique (accompagner les utilisateurs dans la mise en place d'un service, déployer un service)",
